...
{
    [HttpGet]
    public async Task<ActionResult<PagedList<DepartmentDetailsDto>>> GetAllDepartmentsAsync([FromQuery]DoctorParams doctorParams)
    {
        var departments=await departmentService.GetAllDepartmentsAsync(doctorParams);
